...
public class Sale {
	...
	public String toString() {
		return "Sale [id=" + id + ", sellerName=" + sellerName + ", visited=" + visited + ", deals=" + deals
				+ ", amount=" + amount + ", date=" + date + ", getId()=" + getId() + ", getSellerName()="
				+ getSellerName() + ", getVisited()=" + getVisited() + ", getDeals()=" + getDeals() + ", getAmount()="
				+ getAmount() + ", getDate()=" + getDate() + ", hashCode()=" + hashCode() + ", getClass()=" + getClass()
